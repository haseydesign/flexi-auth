...
<head>
	<meta charset="utf-8">
	<title>Conception | User Guide | flexi auth | A User Authentication Library for CodeIgniter</title>
	<meta name="description" content="The principle ideas of how flexi auth works."/> 
	<meta name="keywords" content="conception, user guide, flexi auth, user authentication, codeigniter"/>
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="intro_text">
				<h1>User Guide | flexi auth conception</h1>
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			...
			<div class="anchor_nav">
				<h6>Conception</h6>
				<p>
					<a href="#conception">The flexi auth Conception</a> | <a href="#structure">Library File Structure</a>
				</p>
			</div>

			<a name="conception"></a>
			<div class="w100 frame">
				<h3 class="heading">The flexi auth Conception</h3>
