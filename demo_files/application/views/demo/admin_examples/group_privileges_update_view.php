		...
		<div class="content clearfix">
			<div class="col100">
				...
				<p>The default setup of this demo uses user groups and privileges to restrict the example public user from accessing the admin area, and the example moderator user from inserting, updating and deleting specific data within the admin area.</p>
                                <hr/>
                                <h3>Privilege Sources</h3>
                                <p>The system configuration setting <em>privilege_sources</em> allows to specify the lookup sources from which the logged in user's privileges are retrieved. Thereby you can choose to grant privileges only on a per user basis or only on a per group basis or on a per user and per group basis.</p>
                                ...
                                <ul class="bullet">
                                    <?php
                                        ...
                                        {
                                            echo '<li><span class="highlight_orange">UGroupser privileges are NOT considered.</span></li>';
                                        }
                                    ?>
                                </ul>
			</div>		
